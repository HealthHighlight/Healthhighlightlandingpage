...
export function Footer() {
  ...
  return (
    <footer
      style={{
        background:
          "linear-gradient(to bottom, rgb(69, 71, 116), rgb(60, 120, 102))",
      }}
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img
                ...
                className="w-12 h-12"
              />
              <span className="font-serif-brand text-xl">Health Highlight</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="https://apps.apple.com/us/app/easy-streak-fitness-simplified/id6478173259"
                  className="text-white/80 hover:text-white transition-colors"
                >
                  Easy Streak
                </a>
        ...
        <div className="mt-12 pt-8 border-t border-white/20 text-center text-white/80">
          <p>
            &copy; 2024-{currentYear} Health Highlight. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
